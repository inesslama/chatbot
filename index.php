		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="images/rec.png" alt="IMG">
				</div>
				...
				<form class="login100-form validate-form" method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="text" name="name" placeholder="Re-enter your name">
						
					</div>

					<div class="wrap-input100 validate-input" data-validate = "complaint is required">
						<input class="input100" type="text" name="email"  style="width: 300px; height: 300px;">
...
if(isset($_POST['submit'])){
	...
	$id=mysqli_query($con,"insert into message(name,email,iv) values('$name','$email','$iv')");
	if($id>0){
